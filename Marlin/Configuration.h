...
#define MACHINE_UUID "2d6b8255-d683-4194-9e2a-82577b689282"
...
#define PID_MAX BANG_MAX // limits current to nozzle while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
  ...
  // Ultimaker
  #define  DEFAULT_Kp 36.08
  #define  DEFAULT_Ki 3.99
  #define  DEFAULT_Kd 81.58
...
#define DELTA
  ...
  #define DELTA_SMOOTH_ROD_OFFSET 189.0 // mm
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3]]]
 */
// TODO: Check the extruder setting
...
#define Z_MIN_POS -5 // A little lower than zero to deal with unlevel beads
...
#define MANUAL_Z_HOME_POS 284.7 // Distance between the nozzle to printbed after homing
